...
var exponent = function(base, exp) {
  ...
  if (exp < 0) {
    var reciprocal = exponent (base, 0 - exp);
    return parseFloat((1 / reciprocal).toFixed(10));
  }
};
...
var countKeysInObj = function(obj, key) {
  ...
  for (current in obj) {
    ...
    if (obj[current] instanceof Object) {
      result = result + countKeysInObj(obj[current], key);
    }
  }
  return result;
};
...
var countValuesInObj = function(obj, value) {
  ...
  for (current in obj) {
    ...
    if (obj[current] instanceof Object) {
      result = result + countValuesInObj(obj[current], value);
    }
  }
  return result;
};
...
var fibonacci = function(n) {
  ...
  return fibonacci(n - 1).concat(fibonacci(n - 1)[n - 1] + fibonacci(n - 2)[n - 2]);
};
...
var capitalizeFirst = function(array) {
  ...
  var capitalize = function (str) {
    var newStr = str[0].toUpperCase() + str.slice(1, str.length);
    return newStr;
  }
  if (array.length === 1) {
    return [capitalize(array[0])];
  }
  return [capitalize(array[0])].concat(capitalizeFirst(array.slice(1, array.length)));
};
...
// I'm aware that I haven't opened/closed my while loop above -- the return isn't where I expected it to be, either. The two errors appear to be conspiring to cause the function to work correctly, however...
...
var augmentElements = function(array, aug) {
  if (array.length) {
    array[0].push(aug);
    return [].concat([array[0]], augmentElements(array.slice(1), aug));
  } else {
    return [];
  }
};
...
var alternateSign = function(array) {
  if (array.length <= 1) {
    return array[0] ? Math.abs(array[0]) : [];
  } else {
...
var numToText = function(str) {
  ...
  if (str.length === 0) {
    ...
    var char = str[0]
    if (parseInt(str[0])) {
      char = digitNames[parseInt(str[0])];
    }
